...
public class TC002_CreateIncident extends TC001_Login {

	
	@Test(dataProvider="sendData")
	public void runCreateIncident(String shortD) throws InterruptedException {
		...
		driver.findElement(By.id("incident.short_description")).sendKeys(shortD);
